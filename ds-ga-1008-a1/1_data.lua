...
--numTrain = trsize  
--numValidation = trsize /5
--numTotal = trsize * 6/5

--trainData_ ={
	--data = loaded.data[{{1,numTrain}}],
	--labels = loaded.labels[{{1,numTrain}}],
	--size = function() return numTrain end
	--} 

----Note: testData here is indeed the validation data 
--testData ={
	--data = loaded.data[{{numTrain+1,numTotal}}],
	--labels = loaded.labels[{{numTrain+1,numTotal}}],
	--size = function() return numValidation end
	--}
...
-- Note the testData_global here is the true test data that is 
-- not used during the model training
